...
const ChartWrapper =({currentPrice,tokenName,setTokenName,ST_Name,setTotalChartData,dataLength,setDataLength,defaultLimit,isLoading,setTermValue,term,chartTermArr})=>{
